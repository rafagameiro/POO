 ...
 */
public class IteratorByFestivalTickets implements Iterator<Tickets> {
	
	private ListIterator<Tickets> tickets;
	/**
	 * 
	 */
	public IteratorByFestivalTickets(List<Tickets> tickets) {
	...
	private void searchNext(){
		while(tickets.hasNext())
			if(tickets.next() instanceof FestivalTickets){
				tickets.previous();
				return;
			}		
	}
